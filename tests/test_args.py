...
CORRECT_BEHAVIOR = [
  ...
  ((), "build --debug --defaults o2,yabba,foo O2"                         , [("debug", True), ("action",  "build"), ("defaults", ["o2","yabba","foo"]), ("pkgname", ["O2"])]),
  ((), "init --defaults o2,foo zlib"                                      , [("action",  "init"), ("defaults", ["o2","foo"])]),
  ((), "doctor --defaults o2,foo zlib"                                    , [("action",  "doctor"), ("defaults", ["o2","foo"])]),
